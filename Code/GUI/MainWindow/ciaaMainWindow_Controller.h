/*! \file ciaaMainWindow_Controller.h
...
#ifndef CIAAMAINWINDOW_CONTROLLER_H
#define CIAAMAINWINDOW_CONTROLLER_H
 ...
 */
namespace Ui {
class ciaaMainWindow_Controller;
}
...
public:
    explicit ciaaMainWindow_Controller(QWidget *parent = 0);
    ~ciaaMainWindow_Controller();
    
private:
    Ui::ciaaMainWindow_Controller *ui;
};

#endif // CIAAMAINWINDOW_CONTROLLER_H
