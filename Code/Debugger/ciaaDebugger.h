/*! \file ciaaDebugger.h
    ...
    \brief This file become from: CIAA_v1_0/Debugger/ciaaDebugger.h
 ...
 * \brief The ciaaDebugger class TODO: document here. see ciaaDriversSerialPort
 * \ingroup Debugger
 */
class ciaaDebugger
{
    DISALLOW_COPY_AND_ASSIGN(ciaaDebugger);

public:
    ciaaDebugger();
};

#endif // CIAADEBUGGER_H
