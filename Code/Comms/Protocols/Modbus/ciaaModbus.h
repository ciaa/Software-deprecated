/*! @file ciaaModbus.h
    ...
    \brief TODO This file is for TODO: plesase document here.
    \brief This file become from: CIAA_v1_0/Comms/Protocols/Modbus/ciaaModbus.h:
...
class ciaaModbus
{
	DISALLOW_COPY_AND_ASSIGN(ciaaModbus);
