/*! \file ciaaIECCompiler.h
    ...
    \brief This file become from: CIAA_v1_0/Compiler/ciaaIECCompiler.h
 ...
 * \brief The ciaaIECCompiler class TODO: document here. see ciaaDriversSerialPort
 * \ingroup Compiler
 */
class ciaaIECCompiler
{
    public:
        ciaaIECCompiler();
    ...
    private:
            DISALLOW_COPY_AND_ASSIGN(ciaaIECCompiler);
};

#endif // CIAAIECCOMPILER_H
