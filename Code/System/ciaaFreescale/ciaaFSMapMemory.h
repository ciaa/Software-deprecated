/*! \file ciaaFSMapMemory.h
    ...
    \brief This file become from: CIAA_v1_0/System/ciaaFreescale/ciaaFSMapMemory.h
 ...
 * \brief The ciaaFSMapMemory class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaFSMapMemory
{
    public:
        ciaaFSMapMemory();
    ...
    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaFSMapMemory);
};

#endif // CIAAFSMAPMEMORY_H
