/*! \file ciaaBaseMapMemory.h
    ...
    \brief This file become from: CIAA_v1_0/System/Base/ciaaBaseMapMemory.h
...
#ifndef CIAABASEMAPMEMORY_H
#define CIAABASEMAPMEMORY_H

#include "Code/Defines/ciaaGlobalMacros.h"

/*! \brief TODO: in one line description. see ciaaDriversSerialPort
 * \brief The ciaaBaseMapMemory class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaBaseMapMemory
{
    public:
        ciaaBaseMapMemory();
    ...
    private:
        DISALLOW_COPY_AND_ASSIGN (ciaaBaseMapMemory);
};

#endif // CIAABASEMAPMEMORY_H
