/*! \file ciaaSTMapMemory.h
    ...
    \brief This file become from: CIAA_v1_0/System/ciaaST/ciaaSTMapMemory.h
...
#ifndef CIAASTMAPMEMORY_H
#define CIAASTMAPMEMORY_H

#include "Code/Defines/ciaaGlobalMacros.h"

/*! \brief TODO: in one line description. see ciaaDriversSerialPort
 * \brief The ciaaSTMapMemory class TODO: document here. see ciaaDriversSerialPort
 * \ingroup System
 */
class ciaaSTMapMemory
{
    public:
        ciaaSTMapMemory();
    ...
    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaSTMapMemory);
};

#endif // CIAASTMAPMEMORY_H
