/*! \file ciaaProgrammer.h
    ...
    \brief This file become from: CIAA_v1_0/Programmer/ciaaProgrammer.h
...
class ciaaProgrammer
{
    ...
    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaProgrammer);
};

#endif // CIAAPROGRAMMER_H
