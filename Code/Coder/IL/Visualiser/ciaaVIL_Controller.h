/*! \file ciaaVIL_Controller.h
    ...
    \brief This file become from: CIAA_v1_0/Coder/IL/Visualiser/ciaaVIL_Controller.h
...
#ifndef CIAAVIL_CONTROLLER_H
#define CIAAVIL_CONTROLLER_H

#include "Code/Defines/ciaaGlobalMacros.h"

/*! \brief TODO: in one line description. see ciaaDriversSerialPort
 * \brief The ciaaVIL_Controller class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaVIL_Controller
{
    public:
        ciaaVIL_Controller();
    ...
    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaVIL_Controller);
};

#endif // CIAAVIL_CONTROLLER_H
