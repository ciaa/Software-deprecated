/*! \file ciaaLAnd.h
    ...
    \brief This file become from: CIAA_v1_0/Coder/Ladder/Operators/ciaaLAnd.h
 ...
 * \brief The ciaaLAnd class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaLAnd
{
    ...
    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaLAnd);
};
