/*! \file ciaaVLadder_View.h
    ...
    \brief This file become from: CIAA_v1_0/Coder/Ladder/Visualiser/ciaaVLadder_View.h
...
#ifndef CIAAVLADDER_VIEW_H
#define CIAAVLADDER_VIEW_H

#include "Code/Defines/ciaaGlobalMacros.h"

/*! \brief TODO: in one line description. see ciaaDriversSerialPort
 * \brief The ciaaVLadder_View class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaVLadder_View
{
    public:
        ciaaVLadder_View();
    ...
    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaVLadder_View);
};

#endif // CIAAVLADDER_VIEW_H
