/*! \file ciaaVLadder_Model.h
    ...
    \brief This file become from: CIAA_v1_0/Coder/Ladder/Visualiser/ciaaVLadder_Model.h
 ...
 * \brief The ciaaVLadder_Modele class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */

class ciaaVLadder_Model
{
    public:
        ciaaVLadder_Model();
    ...
    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaVLadder_Model);
};

#endif // CIAAVLADDER_MODEL_H
