/*! \file ciaaLInput_Controller.h
    ...
    \brief This file become from: CIAA_v1_0/Coder/Ladder/Elements/ciaaLInput_Controller.h
...
#ifndef CIAALINPUT_CONTROLLER_H
 ...
 * \brief The ciaaLInput_Controller class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaLInput_Controller : public ciaaLContact_Controller
{
    public:
        ciaaLInput_Controller();


    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaLInput_Controller);
};

#endif // CIAALINPUT_CONTROLLER_H
