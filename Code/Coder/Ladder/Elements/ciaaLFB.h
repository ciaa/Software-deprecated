/*! \file ciaaLFB.h
    ...
    \brief This file become from: CIAA_v1_0/Coder/Ladder/Elements/ciaaLFB.h
 ...
 * \brief The ciaaLFB class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaLFB
{
    ...
    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaLFB);
};
