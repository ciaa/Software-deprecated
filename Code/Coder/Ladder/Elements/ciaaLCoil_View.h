/*! \file ciaaLCoil_View.h
    ...
    \brief This file become from: CIAA_v1_0/Coder/Ladder/Elements/ciaaLCoil_View.h
...
#ifndef CIAALCOIL_VIEW_H
#define CIAALCOIL_VIEW_H

#include "ciaaLElement_View.h"

/*! \brief TODO: in one line description. see ciaaDriversSerialPort
 * \brief The ciaaLCoil_View class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaLCoil_View : public ciaaLElement_View
{
    public:
        ciaaLCoil_View();
    ...
    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaLCoil_View);
};

#endif // CIAALCOIL_VIEW_H
