/*! \file ciaaLContact_Controller.h
    ...
    \brief This file become from: CIAA_v1_0/Coder/Ladder/Elements/ciaaLContact_Controller.h
 ...
 * \brief The ciaaLContact_Controller class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaLContact_Controller
{
    public:
        ciaaLContact_Controller();


    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaLContact_Controller);
};

#endif // CIAALCONTACT_CONTROLLER_H
