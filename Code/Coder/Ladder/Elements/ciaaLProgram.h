/*! \file ciaaLProgram.h
    ...
    \brief This file become from: CIAA_v1_0/Coder/Ladder/Elements/ciaaLProgram.h
...
#ifndef CIAALPROGRAM_H
#define CIAALPROGRAM_H

#include "Code/Defines/ciaaGlobalMacros.h"

/*! \brief TODO: in one line description. see ciaaDriversSerialPort
 * \brief The ciaaLProgram class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaLProgram
{
    ...
    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaLProgram);
};

#endif // CIAALPROGRAM_H
