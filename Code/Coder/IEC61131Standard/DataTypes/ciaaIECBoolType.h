/*! \file ciaaIECBoolType.h
    ...
    \brief This file become from: /home/adacosta/WORK/Project/CIAA_v1_0/Coder/IEC61131Standard/DataTypes/ciaaIECBoolType.h
...
#ifndef CIAAIECBOOLTYPE_H
#define CIAAIECBOOLTYPE_H

#include "Code/Defines/ciaaGlobalMacros.h"

/*! \brief TODO: in one line description. see ciaaDriversSerialPort
 * \brief The ciaaIECBoolType class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaIECBoolType
{
    public:
        ciaaIECBoolType();

    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaIECBoolType);
};

#endif // CIAAIECBOOLTYPE_H
