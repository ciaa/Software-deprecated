/*! \file ciaaIECDIntType.h
    ...
    \brief This file become from: /home/adacosta/WORK/Project/CIAA_v1_0/Coder/IEC61131Standard/DataTypes/ciaaIECDIntType.h
...
#ifndef CIAAIECDINTTYPE_H
#define CIAAIECDINTTYPE_H

#include "Code/Defines/ciaaGlobalMacros.h"

/*! \brief TODO: in one line description. see ciaaDriversSerialPort
 * \brief The ciaaIECDIntType class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaIECDIntType
{
    public:
        ciaaIECDIntType();

    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaIECDIntType);
};

#endif // CIAAIECDINTTYPE_H
