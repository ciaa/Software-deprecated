/*! \file ciaaIECDWordType.h
    ...
    \brief This file become from: /home/adacosta/WORK/Project/CIAA_v1_0/Coder/IEC61131Standard/DataTypes/ciaaIECDWordType.h
...
#ifndef CIAAIECDWORDTYPE_H
#define CIAAIECDWORDTYPE_H

#include "Code/Defines/ciaaGlobalMacros.h"

/*! \brief TODO: in one line description. see ciaaDriversSerialPort
 * \brief The ciaaIECDWordType class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaIECDWordType
{
    public:
        ciaaIECDWordType();

    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaIECDWordType);
};

#endif // CIAAIECDWORDTYPE_H
