/*! \file ciaaIECDBaseType.h
    ...
    \brief This file become from: /home/adacosta/WORK/Project/CIAA_v1_0/Coder/IEC61131Standard/DataTypes/ciaaIECDBaseType.h
...
#ifndef CIAAIECDBASETYPE_H
#define CIAAIECDBASETYPE_H

#include "Code/Defines/ciaaGlobalMacros.h"

/*! \brief TODO: in one line description. see ciaaDriversSerialPort
 * \brief The ciaaIECDBaseType class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaIECDBaseType
{
    public:
        ciaaIECDBaseType();

    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaIECDBaseType);
};

#endif // CIAAIECDBASETYPE_H
