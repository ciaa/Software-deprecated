/*! \file ciaaIECWordType.h
    ...
    \brief This file become from: /home/adacosta/WORK/Project/CIAA_v1_0/Coder/IEC61131Standard/DataTypes/ciaaIECWordType.h
...
#ifndef CIAAIECWORDTYPE_H
#define CIAAIECWORDTYPE_H

#include "Code/Defines/ciaaGlobalMacros.h"

/*! \brief TODO: in one line description. see ciaaDriversSerialPort
 * \brief The ciaaIECWordType class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaIECWordType
{
    public:
        ciaaIECWordType();

    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaIECWordType);
};

#endif // CIAAIECWORDTYPE_H
