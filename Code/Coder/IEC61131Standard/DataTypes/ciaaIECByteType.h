/*! \file ciaaIECByteType.h
    ...
    \brief This file become from: /home/adacosta/WORK/Project/CIAA_v1_0/Coder/IEC61131Standard/DataTypes/ciaaIECByteType.h
...
#ifndef CIAAIECBYTETYPE_H
#define CIAAIECBYTETYPE_H

#include "Code/Defines/ciaaGlobalMacros.h"

/*! \brief TODO: in one line description. see ciaaDriversSerialPort
 * \brief The ciaaIECByteType class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaIECByteType
{
    public:
        ciaaIECByteType();

    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaIECByteType);
};

#endif // CIAAIECBYTETYPE_H
