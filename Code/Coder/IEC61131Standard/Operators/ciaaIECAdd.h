/*! \file ciaaIECAdd.h
    ...
    \brief This file become from: CIAA_v1_0/Coder/IEC61131Standard/Operators/ciaaIECAdd.h
 ...
 * \brief The ciaaIECAdd class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaIECAdd : ciaaIECBaseElement
{
    public:
        ciaaIECAdd();

    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaIECAdd);
};
