/*! \file ciaaIECAnd.h
    ...
    \brief This file become from: CIAA_v1_0/Coder/IEC61131Standard/Operators/ciaaIECAnd.h
 ...
 * \brief The ciaaIECAnd class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaIECAnd : ciaaIECBaseElement
{
    public:
        ciaaIECAnd();

    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaIECAnd);
};
