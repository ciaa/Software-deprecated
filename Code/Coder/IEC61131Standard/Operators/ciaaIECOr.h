/*! \file ciaaIECOr.h
    ...
    \brief This file become from: CIAA_v1_0/Coder/IEC61131Standard/Operators/ciaaIECOr.h
 ...
 * \brief The ciaaIECOr class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaIECOr : ciaaIECBaseElement
{
    public:
        ciaaIECOr();

    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaIECOr);
};
