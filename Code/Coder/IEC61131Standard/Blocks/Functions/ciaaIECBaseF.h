/*! \file ciaaIECBaseF.h
    ...
    \brief This file become from: CIAA_v1_0/Coder/IEC61131Standard/Blocks/Functions/ciaaIECBaseF.h
...
#ifndef CIAAIECBASEF_H
#define CIAAIECBASEF_H
 ...
 * \brief The ciaaIECBaseF class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaIECBaseF : ciaaIECBaseBlock
{
    public:
        ciaaIECBaseF();

    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaIECBaseF);
};

#endif // CIAAIECBASEF_H
