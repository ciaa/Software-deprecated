/*! \file ciaaIECBaseProgram.cpp
    ...
    \brief This file become from: CIAA_v1_0/Coder/IEC61131Standard/Blocks/Programs/ciaaIECBaseProgram.cpp
 ...
 * \brief The ciaaIECBaseProgram class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaIECBaseProgram : ciaaIECBaseBlock
{
    public:
        ciaaIECBaseProgram();

    public:
        DISALLOW_COPY_AND_ASSIGN(ciaaIECBaseProgram);
};

#endif // CIAAIECBASEPROGRAM_H
