/*! \file ciaaIECResource.h
    ...
    \brief This file become from: CIAA_v1_0/Coder/IEC61131Standard/ConfigElements/Resources/ciaaIECResource.h
 ...
 * \brief The ciaaIECResource class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaIECResource
{
    public:
        ciaaIECResource();

    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaIECResource);

        //! Pointer to the ciaa's memory map used by the program
        ciaaBaseMapMemory* pMapMemory;
};

#endif // CIAAIECRESOURCE_H
