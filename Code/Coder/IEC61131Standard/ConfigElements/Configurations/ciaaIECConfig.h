/*! \file ciaaIECConfig.h
    ...
    \brief This file become from: CIAA_v1_0/Coder/IEC61131Standard/ConfigElements/Configurations/ciaaIECConfig.h
...
#ifndef CIAAIECCONFIG_H
#define CIAAIECCONFIG_H

#include "Code/Defines/ciaaGlobalMacros.h"

/*! \brief TODO: in one line description. see ciaaDriversSerialPort
 * \brief The ciaaIECConfig class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaIECConfig
{
    ...
    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaIECConfig);
};

#endif // CIAAIECCONFIG_H
