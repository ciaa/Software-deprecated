/*! \file ciaaIECVariable.h
    ...
    \brief This file become from: CIAA_v1_0/Coder/IEC61131Standard/Variables/ciaaIECVariable.h
...
#ifndef CIAAIECVARIABLE_H
#define CIAAIECVARIABLE_H

#include "Code/Defines/ciaaGlobalMacros.h"

/*! \brief TODO: in one line description. see ciaaDriversSerialPort
 * \brief The ciaaIECVariable class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaIECVariable
{
    public:
        ciaaIECVariable();

    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaIECVariable);
};

#endif // CIAAIECVARIABLE_H
