/*! \file ciaaIECArrays.h
    ...
    \brief This file become from: CIAA_v1_0/Coder/IEC61131Standard/Variables/ciaaIECArrays.h
...
#ifndef CIAAIECARRAYS_H
#define CIAAIECARRAYS_H

#include "Code/Defines/ciaaGlobalMacros.h"

/*! \brief TODO: in one line description. see ciaaDriversSerialPort
 * \brief The ciaaIECArrays class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaIECArrays
{
    ...
    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaIECArrays);
};

#endif // CIAAIECARRAYS_H
