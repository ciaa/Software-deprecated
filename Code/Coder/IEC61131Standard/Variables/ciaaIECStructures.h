/*! \file ciaaIECStructures.h
    ...
    \brief This file become from: CIAA_v1_0/Coder/IEC61131Standard/Variables/ciaaIECStructures.h
...
#ifndef CIAAIECSTRUCTURES_H
#define CIAAIECSTRUCTURES_H

#include "Code/Defines/ciaaGlobalMacros.h"

/*! \brief TODO: in one line description. see ciaaDriversSerialPort
 * \brief The ciaaIECStructures class TODO: document here. see ciaaDriversSerialPort
 * \ingroup TODO: see
 */
class ciaaIECStructures
{
    public:
        ciaaIECStructures();

    private:
        DISALLOW_COPY_AND_ASSIGN(ciaaIECStructures);
};

#endif // CIAAIECSTRUCTURES_H
